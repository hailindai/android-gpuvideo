 ...
 */
public class GPUVideoEmbossFilter2D extends GPUVideo3x3ConvolutionFilter2D {
    private float mIntensity;

    public GPUVideoEmbossFilter2D() {
        this(1.0f);
    }

    public GPUVideoEmbossFilter2D(final float intensity) {
        super();
