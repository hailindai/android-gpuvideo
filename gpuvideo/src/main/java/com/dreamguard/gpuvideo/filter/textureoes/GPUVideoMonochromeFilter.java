 ...
 *  单色画，单色照片，黑白照片
 */
public class GPUVideoMonochromeFilter extends GPUVideoFilter {
    ...
    public GPUVideoMonochromeFilter() {
        this(1.0f, new float[] {0.6f, 0.45f, 0.3f, 1.0f});
    }

    public GPUVideoMonochromeFilter(final float intensity, final float[] color) {
