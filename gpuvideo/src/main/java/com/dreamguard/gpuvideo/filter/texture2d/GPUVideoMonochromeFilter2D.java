 ...
 *  单色画，单色照片，黑白照片
 */
public class GPUVideoMonochromeFilter2D extends GPUVideoFilter2D {
    ...
    public GPUVideoMonochromeFilter2D() {
        this(1.0f, new float[] {0.6f, 0.45f, 0.3f, 1.0f});
    }

    public GPUVideoMonochromeFilter2D(final float intensity, final float[] color) {
