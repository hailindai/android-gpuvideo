...
public class GPUVideoBitmapInputFilter extends GPUVideoFilter {
    ...
    public GPUVideoBitmapInputFilter() {
        this(VERTEX_SHADER, BLEND_FRAGMENT_SHADER);
    }

    public GPUVideoBitmapInputFilter(String fragmentShader) {
        this(VERTEX_SHADER, fragmentShader);
    }

    public GPUVideoBitmapInputFilter(String vertexShader, String fragmentShader) {
