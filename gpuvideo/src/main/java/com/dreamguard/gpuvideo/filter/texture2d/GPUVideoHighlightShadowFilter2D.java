 ...
 */
public class GPUVideoHighlightShadowFilter2D extends GPUVideoFilter2D {
    public static final String HIGHLIGHT_SHADOW_FRAGMENT_SHADER = "" +
            ...
            " void main()\n" +
            " {\n" +
            " 	lowp vec4 source = texture2D(inputTexture, textureCoordinate);\n" +
    ...
    public GPUVideoHighlightShadowFilter2D() {
        this(0.0f, 1.0f);
    }

    public GPUVideoHighlightShadowFilter2D(final float shadows, final float highlights) {
