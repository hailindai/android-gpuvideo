 ...
 * blue:
 */
public class GPUVideoRGBFilter extends GPUVideoFilter {
    ...
    public GPUVideoRGBFilter() {
        this(1.0f, 1.0f, 1.0f);
    }

    public GPUVideoRGBFilter(final float red, final float green, final float blue) {
