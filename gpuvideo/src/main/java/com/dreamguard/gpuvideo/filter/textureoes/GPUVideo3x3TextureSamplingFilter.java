...
public class GPUVideo3x3TextureSamplingFilter extends GPUVideoFilter {
    ...
    public GPUVideo3x3TextureSamplingFilter() {
        this(NO_FILTER_VERTEX_SHADER);
    }

    public GPUVideo3x3TextureSamplingFilter(final String fragmentShader) {
