 ...
 */
public class GPUVideoHighlightShadowFilter extends GPUVideoFilter {
    ...
    public GPUVideoHighlightShadowFilter() {
        this(0.0f, 1.0f);
    }

    public GPUVideoHighlightShadowFilter(final float shadows, final float highlights) {
