...
public class GPUVideoDirectionalSobelEdgeDetectionFilter2D extends GPUVideo3x3TextureSamplingFilter2D {
    ...
    public GPUVideoDirectionalSobelEdgeDetectionFilter2D() {
